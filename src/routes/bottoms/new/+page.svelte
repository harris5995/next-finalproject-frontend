...
<h1 class="text-center text-3xl font-bold">Upload Your Bottom Here</h1>
...
<div class="flex justify-center items-center mt-8">
    <form on:submit={uploadImages} class="w-1/3">
        ...
        <div class="form-control w-full">
            ...
            <input type="text" name="name" placeholder="Blue Jeans" class="input input-bordered w-full" required />
        ...
        <div class="form-control w-full">
            ...
            <input type="input" name="size" placeholder="S/M/L/XL or Waist Size: 28 etc" class="input input-bordered w-full" required />
            {#if 'color' in formErrors}
            <label class="label" for="size">
