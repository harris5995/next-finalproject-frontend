...
<script>
    ...
    async function uploadImages(evt) {
        ...
        const resp = await fetch(PUBLIC_BACKEND_BASE_URL + '/accessories', {
        method: 'POST',
        mode: 'cors',
        headers: {
...
<div class="flex justify-center items-center mt-8">
    <form on:submit={uploadImages} class="w-1/3">
        <div class="form-control w-full">
            ...
            <input type="text" name="name" placeholder="Swatch Watch" class="input input-bordered w-full" required />
        ...
        <div class="form-control w-full">
            ...
            <input type="input" name="brand" placeholder="Swatch" class="input input-bordered w-full" required />
