...
<div class="flex justify-center items-center mt-8">
    <form on:submit={uploadImages} class="w-1/3">
        ...
        <div class="form-control w-full">
            ...
            <input type="text" name="name" placeholder="Necklace" class="input input-bordered w-full" required />
        ...
        <div class="form-control w-full">
            ...
            <input type="input" name="brand" placeholder="Swarovski" class="input input-bordered w-full" required />
